  ...
  */
  ...
  IScroll.prototype = {
    ...
    refresh: function () {
      ...
      if (this.wrapperOffsetTop) this.wrapperOffset.top = this.wrapperOffsetTop;
    ...
    getScrollerWidth: function () {
      return this.scrollerW !== undefined
        ? this.scrollerW
        : this.scroller.offsetWidth;
    },

    getScrollerHeight: function () {
      return this.scrollerH !== undefined
        ? this.scrollerH
    ...
    scrollTo: function (x, y, time, easing) {
      ...
      if (time) {
        ...
        if (
          this.nextDisabled &&
          x == -(this.scrollerWidth - this.wrapperWidth)
        ) {
          this.goToPage(1, 0, 0);
          return;
        }
      ...
      if (
        ...
        y =
          this.wrapperHeight / 2 - (this.getScrollerHeight() * this.scale) / 2;
      /*end custom*/
