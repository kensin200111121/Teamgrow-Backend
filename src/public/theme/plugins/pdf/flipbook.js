  ...
  (function init(jQuery, window, document, undefined) {
    ...
    FLIPBOOK.Main = function (options, elem) {
      ...
      if (o.viewMode == 'webgl') {
        if (
          !this.hasWebGl ||
          (parseFloat(getAndroidVersion()) < o.minimumAndroidVersion &&
            this.isAndroid)
        )
          o.viewMode = '3d';
      }
      ...
      this.wrapper = jQuery(document.createElement('div')).addClass(
      ...
      if (o.backgroundPattern != '')
        this.wrapper.css(
          'background',
          'url(' + o.backgroundPattern + ') repeat'
        );

      if (o.backgroundImage != '') {
        this.wrapper.css(
          'background',
          'url(' + o.backgroundImage + ') no-repeat'
        );
      ...
      if (o.preloader) this.preloader = o.preloader;
      ...
      else this.preloader = jQuery('.flipbook-preloader');
      ...
      o.deeplinkingEnabled =
        o.deeplinkingPrefix ||
        o.deeplinkingEnabled ||
        (o.deeplinking && o.deeplinking.enabled);
      ...
      function preload() {
        ...
        if (
          typeof FLIPBOOK.PdfService == 'undefined' &&
      ...
      function init() {
        if (o.fillPreloader.enabled) {
          self.$fillPreloader = jQuery('<div>').addClass(
          ...
          empty.onload = function () {
            ...
            full.onload = function () {
              ...
              self.$fillPreloaderImg = jQuery(full).appendTo(
                self.$fillPreloader
              );
      ...
      model.on('pageLoaded', function (e) {
        ...
        if (self.searchingString) self.mark(self.searchingString, true);
      });
      ...
      model.on('pdfinit', function () {
        ...
        o.firstPage = {
          ...
          ratio:
            self.pdfService.viewports[0].width /
            self.pdfService.viewports[0].height,
        };
        ...
        if (self.pdfService.numPages > 1)
          o.secondPage = {
            ...
            ratio:
              self.pdfService.viewports[1].width /
              self.pdfService.viewports[1].height,
          };
        ...
        o.pageWidth = parseInt(
          (pageSize * self.viewportOriginal.width) /
            self.viewportOriginal.height
        );
    ...
    FLIPBOOK.Main.prototype = {
      ...
      updateSkinColors: function () {
        ...
        if (o.skinBackground)
          this.wrapper
            .find('.skin-color-bg')
            .css('background', o.skinBackground);
      },
      ...
      setHash: function (page) {
        ...
        if (
          ...
          window.location.hash =
            '#' + this.options.deeplinkingPrefix + String(page);
          this.hash = page;
        }
      },
      ...
      lightboxEnd: function () {
        ...
        if (this.Book) this.Book.disable();
      },
      ...
      initPdf: function () {
        ...
        if (location.protocol == 'https:')
          self.options.pdfUrl = self.options.pdfUrl.replace(
            'http://',
            'https://'
          );
        ...
        loadingTask.promise.then(
          function (pdf) {
            ...
            self.pdfService = new FLIPBOOK.PdfService(
              pdf,
              self.model,
              self.options
            );
              ...
              jQuery(page.htmlContent)
                ...
                .each(function () {
                  ...
                  this.onclick = function () {
                    ...
                    num = main.options.rightToLeft
                      ? main.options.pages.length - num + 1
                      : num;
      ...
      loadPage: function (index, size, callback) {
        var self = this,
          pageSrc =
            this.options.pages &&
            this.options.pages[index] &&
            this.options.pages[index].src;
        ...
        if (this.options.pdfMode && !pageSrc) {
          ...
          if (!page.img) {
            ...
            page.img.onload = function () {
              ...
              self.pageLoaded(
                { index: index, size: size, image: page.img },
                callback
              );
            };
      ...
      pageLoaded: function (page, callback) {
        ...
        if (
          ...
          page.index < this.options.numPages - 1
        ) {
          this.loadPage(page.index + 1, page.size, function () {});
        }

        if (this.searchingString) this.mark(this.searchingString, true);
      },
      ...
      scrollPageIntoView: function (obj) {
        var num = this.options.rightToLeft
          ? this.options.pages.length - obj.pageNumber + 1
          : obj.pageNumber;
      ...
      createBook: function () {
        ...
        if (
          /*!self.options.pdfMode && */ self.options.doublePage &&
          self.options.pages.length > 2
        ) {
        ...
        if (
          ...
          !this.options.singlePageMode /*&& this.options.viewMode != 'swipe' */
        ) {
          this.oddPages = true;
        ...
        if (self.options.pages.length > 0) {
          for (var i = 0; i < self.options.pages.length; i++) {
            if (typeof self.options.pages[i].htmlContent != 'undefined') {
              ...
              self.options.pages[i].htmlContent = jQuery(
                self.options.pages[i].htmlContent
              );
            }
          }
        }
        ...
        function initSound() {
          ...
          self.flipsound = jQuery(
            '<audio><source src="' +
              self.options.assets.flipMp3 +
        ...
        if (self.options.viewMode == 'webgl') {
          ...
          self.Book = new FLIPBOOK.BookSwipe(
            self.book[0],
            self.bookLayer[0],
            model,
            options
            ...
            for (var key2 in page.items) {
              ...
              switch (item.type) {
                ...
                case 'video':
                  ...
                  var src = jQuery('<source type="video/mp4">')
                    .attr('src', item.src)
                    .appendTo(el);
      ...
      onBookCreated: function () {
        ...
        document.addEventListener('keydown', function (e) {
          ...
          if (
            self.options.arrowsAlwaysEnabledForNavigation &&
            ...
            if (!self.options.lightBox && !self.fullscreenActive) {
              if (
                self.options.arrowsDisabledNotFullscreen ||
                self.bodyHasVerticalScrollbar()
              )
                return;
            }
          }
        ...
        if (o.lightboxCloseOnBack) {
          window.onpopstate = function () {
            if (self.Book.enabled && FLIPBOOK.lightboxOpened) {
              if (!window.location.hash) self.lightbox.closeLightbox(true);
            }
          };
        }
        ...
        this.bookLayer.bind('DOMMouseScroll', function (e) {
          ...
          if (!self.options.lightBox && !self.fullscreenActive) {
            if (
              self.options.wheelDisabledNotFullscreen ||
              self.bodyHasVerticalScrollbar()
            )
              return;
          }
        ...
        this.bookLayer.bind('mousewheel', function (e) {
          ...
          if (
            ...
            0 /*|| e.originalEvent.deltaY < 0  -> zoom in does not work in chrome*/
          ) {
            //scroll down
            // console.log('Down');
            self.zoomOut(e.originalEvent);
        ...
        if (self.options.contentOnStart) self.toggleToc(true);
          ...
          if (typeof self.options.searchOnStart == 'string') {
            self.thumbs.$findInput
              .val(self.options.searchOnStart)
              .trigger('keyup');
          }
        }
        ...
        window.jQuery(this.bookLayer).swipe({
          swipeStatus: function (
            ...
            if (
              ...
              if (
                self.tool == 'toolMove' &&
                !self.options.doubleClickZoomDisabled
              ) {
                if (self.clickTimer == null) {
                  ...
                  else self.zoomTo(self.options.zoomMax, t, e);
                }
              }
          ...
          pinchStatus: function (
            ...
            if (fingerCount > 1 && phase == 'move') {
              ...
              if (event.scale) pinchZoom = event.scale;
      ...
      createButton: function (btn) {
        var o = this.options;
        var floating =
          (btn.vAlign == 'top' && o.menu2Transparent) ||
          (btn.vAlign != 'top' && o.menuTransparent);
        var bgColor =
          btn.background ||
          (floating ? o.floatingBtnBackground : o.btnBackground);
        var bgColorHover =
          btn.backgroundHover ||
          (floating ? o.floatingBtnBackgroundHover : o.btnBackgroundHover);
        var color = btn.color || (floating ? o.floatingBtnColor : o.btnColor);
        var colorHover =
          btn.colorHover ||
          (floating ? o.floatingBtnColorHover : o.btnColorHover);
        var textShadiw = floating ? o.floatingBtnTextShadow : o.btnTextShadow;
        var radius =
          btn.radius || (floating ? o.floatingBtnRadius : o.btnRadius);
        var border =
          btn.border || (floating ? o.floatingBtnBorder : o.btnBorder);
        ...
        var btnSize = material
          ? (btn.size || o.btnSize) + 8
          : btn.size || o.btnSize;
        ...
        if (colorHover || bgColorHover)
          $btn
            .mouseenter(function () {
              ...
              if ($btn.$iconAlt)
                $btn.find('.' + $btn.iconAlt.replace('fas ', '')).css({
                  color: colorHover,
                  background: bgColorHover,
                });
            })
      ...
      createMenu: function () {
        ...
        var menuBottomClass = o.menuFloating
          ? 'flipbook-menu-floating'
          : 'flipbook-menu-fixed';
        var menuTopClass = o.menu2Floating
          ? 'flipbook-menu-floating'
          : 'flipbook-menu-fixed';
          ...
          if (o.btnFirst.enabled) {
            ...
            this.arrowFirst = this.createIcon(o.btnFirst)
              ...
              .css({
                ...
                'margin-top':
                  String(
                    o.sideBtnSize / 2 + o.sideBtnMargin + 2 * o.sideBtnPaddingV
                  ) + 'px',
                'margin-left': o.sideBtnMargin + 'px',
                padding: o.sideBtnPaddingV + 'px ' + o.sideBtnPaddingH + 'px',
                'text-shadow': o.sideBtnTextShadow,
        ...
        for (var i = 0; i < o.btnOrder.length; i++) {
          ...
          if (btn.enabled) {
            ...
            if (btn.name == 'currentPage') {
              ...
              this[btnName] = this.createButton(btn).bind(
                'touchend click',
                function (e) {
                  e.stopPropagation();
                  e.preventDefault();
      ...
      onButtonClick: function (btn, e) {
        ...
        switch (name) {
          ...
          case 'btnPrint':
            if (o.printMenu) this.togglePrintMenu();
            else this.togglePrintWindow();
      ...
      handleFsChange: function (e) {
        ...
        if (
          currentFullscreenElement === this.fullscreenElement ||
          this.isFullscreen
        ) {
      ...
      setLoadingProgress: function (percent) {
        ...
        if (this.$fillPreloader) this.setFillPreloaderProgress(percent);
        else {
      ...
      setFillPreloaderProgress: function (percent) {
        ...
        if (percent > 0 && percent < 1) {
          ...
          if (percent < this.fillPreloaderProgress) return;
          else this.fillPreloaderProgress = percent;
          // percent = .5
          var img = this.$fillPreloaderImg[0];
          img.style.clip =
            'rect(0px,' + img.width * percent + 'px,' + img.height + 'px,0px)';
      ...
      playFlipSound: function () {
        ...
        if (
          this.options.sound &&
          this.Book.enabled &&
          typeof this.flipsound.play != 'undefined'
        ) {
      ...
      onMouseWheel: function (e) {
        ...
        if (wheelDeltaX > 0) this.zoomIn(e);
        else this.zoomOut(e);
      },
      ...
      zoomOut: function (e) {
        ...
        newZoom =
          newZoom < this.options.zoomMin ? this.options.zoomMin : newZoom;
      ...
      moveBook: function (direction) {
        if (this.Book && this.Book.move) this.Book.move(direction);
      },
      ...
      createCurrentPage: function () {
        ...
        currentPageHolder.css(
          'margin',
          o.currentPage.marginV + 'px ' + o.currentPage.marginH + 'px'
        );
      ...
      createMenuHeader: function (elem, title, onClose) {
        ...
        var $icon = this.createIcon(this.options.btnClose, null, true).appendTo(
          btnClose
        );
        // .attr('aria-hidden', 'true')
      ...
      createTocItem: function (item, parent, level) {
        ...
        if (item.items && item.items.length) {
          ...
          for (var i = 0; i < item.items.length; i++) {
            var subItem = this.createTocItem(
              item.items[i],
              tocItem,
              tocItem.level + 1
            );
      ...
      toggleShareMenu: function () {
        ...
        if (!this.shareMenu) {
          ...
          var shareBtn = jQuery('<idv class="flipbook-share">').appendTo(
            content
          );
      ...
      togglePrintWindow: function (value) {
        ...
        function printme() {
          ...
          for (var i = 0; i < self.options.pages.length; i++) {
            if (self.options.pages[i].src)
              images +=
                '<img src="' + self.options.pages[i].src.toString() + '"/>\n';
          }
        ...
        if (!this.printWindowCreated) {
          ...
          this.printWindow = jQuery('<div>')
            .addClass('flipbook-print-window')
            .appendTo(this.wrapper);
          var html = jQuery(
        ...
        if (this.autoplay) {
          this.autoplayTimer = setInterval(function () {
            if (self.autoplay) {
              ...
              if (self.options.rightToLeft) {
                if (self.Book.prevEnabled) self.prevPage();
                else if (self.options.autoplayLoop)
                  self.goToPage(
                    self.options.pages.length - autoplayStartPage + 1
                  );
              } else {
                if (self.Book.nextEnabled) self.nextPage();
                else if (self.options.autoplayLoop)
...

    {
      ...
      FLIPBOOK.Thumbnails = function (main) {
        ...
        main.createMenuHeader(
          this.thumbHolder,
          main.strings.thumbnails,
          main.toggleThumbs
        );
        ...
        this.$searchBar = jQuery(
          '<div class="flipbook-findbar" id="findbar" deluminate_imagetype="png">' +
            ...
            '<input id="findInput" class="toolbarField" title="Find" placeholder="' +
          ...
          if (str != '') {
            ...
            if (pdfService) {
              for (var i = 0; i < pdfService.pdfInfo.numPages; i++) {
                pdfService.findInPage(
                  str,
                  i,
                  function (matches, htmlContent, index) {
                    if (matches > 0) {
        ...
        for (var i = 0; i < arr.length; i++) {
          ...
          var hasBackCover =
            options.doublePage && options.pages.length % 2 == 0;
          ...
          if (isBackCover) {
            ...
            var $pageNumber = jQuery(document.createElement('soan'))
              .text(String(2 * i))
              .appendTo($thumb)
              .addClass('skin-color')
            ...
            var $pageNumber = jQuery(document.createElement('span'))
              .text(i + 1)
              .appendTo($thumb)
              .addClass('skin-color')
              .addClass('flipbook-thumb-num');
...

    {
      ...
      FLIPBOOK.Lightbox = function (context, content, options) {
        ...
        if (options.lightboxBackgroundPattern)
          self.overlay.css(
            'background',
            'url(' + options.lightboxBackgroundPattern + ') repeat'
          );

        if (options.lightboxBackgroundImage) {
          self.overlay.css(
            'background',
            'url(' + options.lightboxBackgroundImage + ') no-repeat'
          );
      ...
      FLIPBOOK.getFlipbookSrc = function () {
        ...
        for (var i = 0; i < scripts.length; i++) {
          ...
          if (src.match('flipbook\\.js') || src.match('flipbook\\.min\\.js'))
            ...
            src.match('flipbook\\.lite\\.js') ||
            src.match('flipbook\\.lite\\.min\\.js')
          )
            // if (src.match("flipbook.js") || src.match("flipbook.min.js"))
      ...
      return (
        ...
        (e.prototype.setup_instance = function (t, e) {
          ...
          for (
            r = t,
              ...
              s = r.getElementsByTagName('label')[0],
              n = r.getElementsByClassName('social')[0],
        ...
        (e.prototype['public'] = function (t) {
          ...
          for (
            ...
            (i = s[n]),
              (e = i.getElementsByClassName('social')[0]),
              l.push(this['event_' + t](e));
          return l;
        }),
