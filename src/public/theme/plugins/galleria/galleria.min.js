...
!(function (a, b, c, d) {
  var e = b.document,
    ...
    A = function (c, d) {
      ...
      a.extend(this, z[c]),
        ...
        this.hasOwnProperty('getUrl')
          ? a.getJSON(this.getUrl(), _videoThumbs)
          : b.setTimeout(_videoThumbs, 400),
    ...
    B = function (a) {
      var b;
      for (var c in z)
        if (((b = a && z[c].reg && a.match(z[c].reg)), b && b.length))
        ...
        if (this.support) {
          var a = function () {
            if (C.instance) {
              ...
              (e.msFullscreenElement && null !== e.msFullscreenElement)
                ? a._enter(C.callback)
                : a._exit(C.callback);
            }
          };
          e.addEventListener('fullscreenchange', a, !1),
            e.addEventListener('MSFullscreenChange', a, !1),
            e.addEventListener('mozfullscreenchange', a, !1),
            e.addEventListener('webkitfullscreenchange', a, !1);
        }
      },
    },
    D = [],
    ...
    J = function (b) {
      I.push(b),
        a.each(H, function (a, c) {
          (c._options.theme != b.name &&
            (c._initialized || c._options.theme)) ||
            ((c.theme = b), c._init.call(c));
        });
    },
    K = (function () {
      return {
          ...
          var d,
            ...
            p = function (a) {
              o(a, 'none', 'transition'),
                c.WEBKIT &&
                  c.TOUCH &&
                  (o(a, 'translate3d(0,0,0)', 'transform'),
                  a.data('revert') &&
                ...
                ? l
                  ? (s.stop && (e.off(m), p(e)),
                    ...
                    a.each(r, function (a, b) {
                      (k = e.css(a)),
                        K.parseValue(k) != K.parseValue(b) && (d = !0),
                        e.css(a, k);
                    }),
                    d
                      ? ((f = []),
        ...
        moveOut: function (a) {
          K.forceStyles(a, { position: 'absolute', left: -1e4 });
        },
        moveIn: function () {
          ...
          if (c) {
            var g =
              s < 9 && b
                ...
                : d;
            K.animate(b, f, { duration: c, complete: g, stop: !0 });
          } else
            s < 9 && b
              ? (K.removeAlpha(b), (b.style.visibility = 'hidden'))
              : e.css(f);
        },
        show: function (b, c, d) {
          d = d || q;
          ...
          if (c) {
            ...
            var h =
              s < 9 && b
                ...
                : d;
            K.animate(b, g, { duration: c, complete: h, stop: !0 });
          } else
            s < 9 && 1 == g.opacity && b
              ? (K.removeAlpha(b), (b.style.visibility = 'visible'))
              : e.css(g);
        },
        wait: function (d) {
          ...
          var e,
            ...
            i = function () {
              return (
                (f = K.timestamp()),
                (e = f - h),
                K.removeFromArray(c._waiters, g),
                d.until(e)
                  ? (d.success(), !1)
                  : 'number' == typeof d.timeout && f >= h + d.timeout
                  ? (d.error(), !1)
                  : void c._waiters.push((g = b.setTimeout(i, 10)))
              );
            };
        ...
        loadCSS: function (b, f, g) {
          ...
          if (
            ...
            return g.call(h, h), h;
          if (((i = e.styleSheets.length), a('#' + f).length))
            a('#' + f).attr('href', b), i--;
          else {
            ...
            if (
              (j.length
                ? j.get(0).parentNode.insertBefore(h, j[0])
    ...
    L = function (b) {
      ...
      return (
        K.insertStyleTag(c, 'galleria-videoicon'),
        a(K.create('galleria-videoicon'))
          .html('<i></i>')
          .appendTo(b)
          .click(function () {
          ...
          fade: function (b, c) {
            a(b.next).css({ opacity: 0, left: 0 }),
              K.animate(
                b.next,
                { opacity: 1 },
                { duration: b.speed, complete: c }
              ),
              b.prev &&
                (a(b.prev).css('opacity', 1).show(),
                K.animate(b.prev, { opacity: 0 }, { duration: b.speed }));
          },
          flash: function (b, c) {
            a(b.next).css({ opacity: 0, left: 0 }),
              b.prev
  ...
  C.listen(),
      ...
      add: function (c) {
        ...
        a(this)
          ...
          .on('touchstart.fast', function (c) {
            b.clearTimeout(a(this).data('timer')),
              a(this).data('clickstate', {
                touched: !0,
                touchdown: !0,
          ...
          .on('touchmove.fast', function (b) {
            var c = d(b.originalEvent),
              ...
              f = Math.max(
                Math.abs(e.coords.x - c.x),
                Math.abs(e.coords.y - c.y)
              );
          ...
          .on('click.fast', function (b) {
            ...
            return (
              !d.touched &&
              (a(this).data('clickstate', e), void c.handler.call(this, b))
            );
          });
      },
      remove: function () {
      ...
      var k = (this._keyboard = {
          ...
          attach: function (a) {
            ...
            for (b in a)
              a.hasOwnProperty(b) &&
                ((c = b.toUpperCase()),
                c in k.keys ? (k.map[k.keys[c]] = a[b]) : (k.map[c] = a[b]));
        ...
        l = (this._controls = {
          ...
          getNext: function () {
            return h._options.swipe
              ? l.slides[h.getNext(h._active)]
              : l[1 - l.active];
          },
          slides: [],
          frames: [],
        ...
        n = (this._carousel = {
            ...
            a.each(h._thumbnails, function (e, f) {
              if (f.ready) {
                ...
                (b += g - p.floor(g)),
                  ...
                  (c = p.max(
                    c,
                    f.outerHeight || a(f.container).outerHeight(!0)
                  ));
              }
            }),
              ...
              h
                ...
                .toggleClass('galleria-carousel', b > n.width),
              (n.width = h.$('thumbnails-list').width());
          },
          ...
          set: function (a) {
            for (a = p.max(a, 0); n.hooks[a - 1] + n.width >= n.max && a >= 0; )
              a--;
          ...
          follow: function (a) {
            ...
            for (
              var b = n.current;
              n.hooks[b] - n.hooks[n.current] < n.width && b <= n.hooks.length;

            )
              b++;
            a - 1 < n.current
              ? n.set(a - 1)
              : a + 2 > b && n.set(a - b + n.current + 2);
          },
          setClasses: function () {
            n.prev.toggleClass('disabled', !n.current),
              n.next.toggleClass(
                'disabled',
                n.hooks[n.current] + n.width >= n.max
              );
          },
          animate: function (b) {
            n.setClasses();
        ...
        o = (this._tooltip = {
          ...
          init: function () {
            ...
            K.insertStyleTag(a, 'galleria-tooltip'),
              h
                .$('tooltip')
        ...
        q = (this._fullscreen = {
            ...
            return M.active
              ? function () {
                  ...
                  h._scaleImage(e),
                    h._scaleImage(d),
                    c &&
                      h._options.trueFullscreen &&
                      a(d.container).add(e.container).trigger('transitionend');
                }
              : b;
          },
          enter: function (a) {
            q.beforeEnter(function () {
              (a = q.parseCallback(a, !0)),
                h._options.trueFullscreen && C.support
                  ? ((q.active = !0),
                    K.forceStyles(h.get('container'), {
                      width: '100%',
                      height: '100%',
                    }),
                    h.rescale(),
                    ...
                    g.resize(q.scale),
                    C.enter(h, a, h.get('container')))
                  : ((q.scrolled = g.scrollTop()),
                    c.TOUCH || b.scrollTo(0, 0),
                    q._enter(a));
            });
          },
          _enter: function (f) {
            (q.active = !0),
              ...
              K.hide(h.getActiveImage()),
              u &&
                q.iframe &&
                ((q.iframe.scrolled = a(b.parent).scrollTop()),
                b.parent.scrollTo(0, 0));
            var i = h.getData(),
              j = h._options,
            ...
            if (
              (k &&
                ...
                K.forceStyles(t().html, l),
                K.forceStyles(t().body, l)),
              u &&
                q.iframe &&
                (K.forceStyles(q.pd.documentElement, l),
                K.forceStyles(q.pd.body, l),
                K.forceStyles(
                  q.iframe,
                  a.extend(l, {
                    width: '100%',
                    ...
                    complete: function (b) {
                      ...
                      d &&
                        a(d)
                          ...
                          .attr('style', a(b.image).attr('style'))
                          .attr('src', b.image.src);
                    },
                  });
                });
              var r = h.getNext(o),
            ...
            h.rescale(function () {
              h.addTimer(
                !1,
                function () {
                  k && K.show(h.getActiveImage()),
                    'function' == typeof f && f.call(h),
                    h.rescale();
                },
                100
              ),
          ...
          exit: function (a) {
            q.beforeExit(function () {
              (a = q.parseCallback(a)),
                h._options.trueFullscreen && C.support ? C.exit(a) : q._exit(a);
            });
          },
          _exit: function (a) {
            q.active = !1;
            ...
            if ((q.parent ? q.parent.prepend(e) : e.insertAfter(q.prev), d)) {
              K.hide(h.getActiveImage()),
                K.revertStyles(h.get('container'), t().html, t().body),
                c.TOUCH || b.scrollTo(0, q.scrolled);
              var f = h._controls.frames[h._controls.active];
              f && f.image && (f.image.src = f.image.src);
            }
            u &&
              q.iframe &&
              (K.revertStyles(q.pd.documentElement, q.pd.body, q.iframe),
              q.iframe.scrolled && b.parent.scrollTo(0, q.iframe.scrolled)),
              h.detachKeyboard(),
            ...
            (b = a(b)),
              a.each(r.trunk, function (a, c) {
                c &&
                  c.length &&
                  !c.not(b).length &&
                  (b.css(b.data('idle').from), r.trunk.splice(a, 1));
              }),
              r.trunk.length || (r.removeEvent(), h.clearTimer(r.timer));
          },
          addEvent: function () {
            (r.bound = !0),
              h.$('container').on('mousemove click', r.showAll),
              'hover' == h._options.idleMode &&
                h.$('container').on('mouseleave', r.hide);
          },
          removeEvent: function () {
            (r.bound = !1),
              h.$('container').on('mousemove click', r.showAll),
              'hover' == h._options.idleMode &&
                h.$('container').off('mouseleave', r.hide);
          },
          addTimer: function () {
            'hover' != h._options.idleMode &&
              h.addTimer(
          ...
          show: function (b) {
            ...
            (r.active && (d.busy || d.complete)) ||
              ...
              K.animate(b, d.from, {
                ...
                complete: function () {
                  (r.active = !0),
                    (a(b).data('idle').busy = !1),
                    (a(b).data('idle').complete = !0);
                },
              })),
              r.addTimer();
          },
        ...
        v = (this._lightbox = {
          ...
          init: function () {
            if (!v.initialized) {
              ...
              (m =
                ...
                K.insertStyleTag(f, 'galleria-lightbox'),
                a.each(b.split(' '), function (a, b) {
                  h.addElement('lightbox-' + b),
                    (d[b] = v.elems[b] = h.get('lightbox-' + b));
                }),
                (v.image = new c.Picture()),
                a.each(
                  {
                ...
                h.append(l),
                a(d.image).append(v.image.container),
                a(t().body).append(d.overlay, d.box),
                k(a(d.close).on('click:fast', v.hide).html('&#215;')),
                a.each(['Prev', 'Next'], function (b, e) {
                  var f = a(d[e.toLowerCase()]).html(
                      /v/.test(e) ? '&#8249;&#160;' : '&#160;&#8250;'
                    ),
                ...
                a(d.overlay).on('click:fast', v.hide),
          ...
          rescale: function (b) {
            ...
            b
              ? a(v.elems.box).css(k)
              : a(v.elems.box).animate(k, {
                  duration: h._options.lightboxTransitionSpeed,
                  easing: h._options.easing,
                  complete: function () {
                    var b = v.image,
                      d = h._options.lightboxFadeSpeed;
                    h.trigger({ type: c.LIGHTBOX_IMAGE, imageTarget: b.image }),
                      a(b.container).show(),
                      a(b.image).animate({ opacity: 1 }, d),
                      K.show(v.elems.info, d);
                  },
                });
          },
          hide: function () {
            (v.image.image = null),
              ...
              a(v.elems.box).hide().find('iframe').remove(),
              K.hide(v.elems.info),
              h.detachKeyboard(),
              h.attachKeyboard(v.keymap),
              (v.keymap = !1),
              K.hide(v.elems.overlay, 200, function () {
                a(this).hide().css('opacity', h._options.overlayOpacity),
                  h.trigger(c.LIGHTBOX_CLOSE);
              });
          },
          showNext: function () {
          ...
          show: function (d) {
            (v.active = d = 'number' == typeof d ? d : h.getIndex() || 0),
              v.initialized || v.init(),
              h.trigger(c.LIGHTBOX_OPEN),
              v.keymap ||
                ((v.keymap = a.extend({}, h._keyboard.map)),
                h.attachKeyboard({
                  escape: v.hide,
                  right: v.showNext,
                  left: v.showPrev,
            ...
            K.hide(v.elems.info);
            try {
              for (i = h._options.preload; i > 0; i--)
                (f = new c.Picture()),
                  (e = h.getData(l)),
                  f.preload(e.big ? e.big : e.image),
                  (l = h.getNext(l));
            } catch (a) {}
            (v.image.isIframe = j.iframe && !j.image),
              a(v.elems.box).toggleClass('iframe', v.image.isIframe),
              a(v.image.container).find('.galleria-videoicon').remove(),
              v.image.load(j.big || j.image || j.iframe, function (c) {
                if (c.isIframe) {
                  var e = a(b).width(),
                    f = a(b).height();
                  if (c.video && h._options.maxVideoSize) {
                    var i = p.min(
                      h._options.maxVideoSize / e,
                      h._options.maxVideoSize / f
                    );
                    i < 1 && ((e *= i), (f *= i));
                  }
                ...
                if (
                  (a(c.image)
                    ...
                    .parent()
                    .height('100%'),
                  (v.elems.title.innerHTML = j.title || ''),
                  (v.elems.counter.innerHTML = d + 1 + ' / ' + k),
                  g.resize(v.rescale),
                  v.rescale(),
                  j.image && j.iframe)
                ) {
                      ...
                      (function (b, c) {
                        return function (d) {
                          a(v.image.container)
                            ...
                            d.preventDefault(),
                            (c.isIframe = !0),
                            c.load(b.iframe + (b.video ? '&autoplay=1' : ''), {
                              width: '100%',
                              height:
                                s < 8 ? a(v.image.container).height() : '100%',
                            });
                        };
                      })(j, c)
                    );
              ...
              a(v.elems.overlay).show().css('visibility', 'visible'),
              a(v.elems.box).show();
          },
        }),
        w = (this._timer = {
          ...
          add: function (a, c, d, e) {
            if (
              ((a = a || new Date().getTime()), (e = e || !1), this.clear(a), e)
            ) {
              var f = c;
              c = function () {
                f(), w.add(a, c, d);
          ...
          clear: function (a) {
            ...
            if (a && a in this.trunk) d.call(this, a);
              ...
              for (c in this.trunk)
                this.trunk.hasOwnProperty(c) && d.call(this, c);
          },
        });
      return this;
    }),
    (c.prototype = {
      ...
      init: function (b, e) {
        if (
          ((e = x(e)),
          (this._original = { target: b, options: e, data: null }),
          (this._target = this._dom.target = b.nodeName ? b : a(b).get(0)),
        ...
        if (
          ...
          e &&
            (e.debug === !1 && (j = !1),
            'number' == typeof e.imageTimeout && (k = e.imageTimeout),
            'string' == typeof e.dummy && (l = e.dummy),
            'string' == typeof e.theme && (this._options.theme = e.theme)),
        ...
        return (
          'object' == typeof this.theme ? this._init() : H.push(this), this
        );
      },
      _init: function () {
        var f = this,
        ...
        if (this._initialized)
          return (
            c.raise('Init failed: Gallery instance already initialized.'), this
          );
        if (((this._initialized = !0), !this.theme))
          return c.raise('Init failed: No theme found.', !0), this;
        if (
          (a.extend(
            !0,
            h,
          ...
          (h.swipe = (function (a) {
            return (
              'enforced' == a || (a !== !1 && 'disabled' != a && !!c.TOUCH)
            );
          })(h.swipe)),
          h.swipe && ((h.clicknext = !1), (h.imagePan = !1)),
          (function (a) {
            return 'getContext' in a
              ? void (G = G || {
                  elem: a,
          ...
          this.bind(c.DATA, function () {
            ...
            f._options.height < 2 &&
              (f._userRatio = f._ratio = f._options.height);
          ...
          this.setCounter('&#8211;'),
          K.hide(f.get('tooltip')),
          this.$('container').addClass(
            [
              c.TOUCH ? 'touch' : 'notouch',
          ...
          this._options.swipe ||
            a.each(new Array(2), function (b) {
              ...
              a(d.container)
                ...
                .prepend(
                  (f._layers[b] = a(K.create('galleria-layer')).css({
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    right: 0,
                ...
                a(f._thumbnails[c].container)
                  ...
                  d &&
                    (f
                      ...
                      .remove(),
                    f._options.carousel &&
                      f._options.carouselFollow &&
                      f._carousel.follow(c));
              },
            })),
            ...
            this.$('stage').on('click', function (c) {
              ...
              if (e) {
                if (e.iframe) {
                  ...
                  return (
                    a(g.container)
                      .css({ width: h, height: i, opacity: 0 })
                      .show()
                      .animate({ opacity: 1 }, 200),
                    void b.setTimeout(function () {
                      g.load(
                        e.iframe + (e.video ? '&autoplay=1' : ''),
                        { width: h, height: i },
                        function (a) {
          ...
          this.$('image-nav-right, image-nav-left')
            ...
            .on('click', function (a) {
              a.preventDefault(),
                (h.clicknext || h.swipe) && a.stopPropagation();
            }),
          a.each(['info', 'counter', 'image-nav'], function (a, b) {
            h[
              'show' +
                b.substr(0, 1).toUpperCase() +
                b.substr(1).replace(/-/, '')
            ] === !1 && K.moveOut(f.get(b.toLowerCase()));
          }),
          this.load(),
          h.keepSource || s || (this._target.innerHTML = ''),
          ...
          this.bind(c.THUMBNAIL, function () {
            this.updateCarousel(),
              ++i == this.getDataLength() &&
                'number' == typeof j &&
                j > 0 &&
                this._carousel.follow(j);
          });
        }
        return (
          h.responsive &&
                  ...
                  function (i) {
                    if (!/(-left|-right)/.test(i.target.className)) {
                      if (
                        ...
                        return f.toggleFullscreen(), void i.preventDefault();
                      (a = g), (d = b), (e = c);
                    }
                  }
                );
        ...
        return (
          a.each(['width', 'height'], function (a, g) {
            e._options[g] && 'number' == typeof e._options[g]
              ? (f[g] = e._options[g])
              : ((b = [
                  K.parseValue(c.css(g)),
                  K.parseValue(d.css(g)),
                  c[g](),
                  d[g](),
                ]),
                e['_' + g] ||
                  b.splice(
                    b.length,
                    K.parseValue(c.css('min-' + g)),
                    K.parseValue(d.css('min-' + g))
                  ),
                (f[g] = p.max.apply(p, b)));
          }),
      ...
      _createThumbnails: function (d) {
        ...
        var f,
          ...
          r =
            'string' == typeof k.thumbnails ? k.thumbnails.toLowerCase() : null,
          t = function (a) {
            return e.defaultView && e.defaultView.getComputedStyle
              ? e.defaultView.getComputedStyle(g.container, null)[a]
              : i.css(a);
          },
          u = function (b, d, e) {
            return function () {
          ...
          w = function (b, d) {
            a(b.container).css('visibility', 'visible'),
              j.trigger({
                type: c.THUMBNAIL,
                thumbTarget: b.image,
                index: b.data.order,
        ...
        for (
          d || ((this._thumbnails = []), this.$('thumbnails').empty());
          this._data[l];
          l++
        )
          (h = this._data[l]),
            ...
            (k.thumbnails !== !0 && 'lazy' != r) || (!h.thumb && !h.image)
              ...
              : ((g = new c.Picture(l)),
                ...
                k.thumbCrop !== !0
                  ...
                  : i.css({ width: g.data.width, height: g.data.height }),
                'lazy' == r
                  ? (i.addClass('lazy'),
                    (g.lazy = !0),
                    g.load(p, { height: g.data.height, width: g.data.width }))
                  : g.load(f, x),
      ...
      lazyLoadChunks: function (a, c) {
        var d = this.getDataLength(),
          ...
          i = this;
        for (c = c || 0; e < d; e++)
          h.push(e), (++f != a && e != d - 1) || (g.push(h), (f = 0), (h = []));
        var j = function (a) {
          var d = g.shift();
          d &&
            b.setTimeout(
      ...
      _run: function () {
        ...
        e._createThumbnails(),
          K.wait({
            ...
            until: function () {
              return (
                c.OPERA && e.$('stage').css('display', 'inline-block'),
                (e._stageWidth = e.$('stage').width()),
                (e._stageHeight = e.$('stage').height()),
                e._stageWidth && e._stageHeight > 50
              );
            },
            success: function () {
              if ((D.push(e), e._options.swipe)) {
                ...
                a.each(new Array(e.getDataLength()), function (b) {
                  ...
                  a(d.container)
                    ...
                    .prepend(
                      (e._layers[b] = a(K.create('galleria-layer')).css({
                        position: 'absolute',
                        top: 0,
                        left: 0,
                        right: 0,
              ...
              return (
                K.show(e.get('counter')),
                e._options.carousel && e._carousel.bindControls(),
                e._options.autoplay &&
                  (e.pause(),
                  'number' == typeof e._options.autoplay &&
                    (e._playtime = e._options.autoplay),
                  (e._playing = !0)),
                e._firstrun
                  ? (e._options.autoplay && e.trigger(c.PLAY),
                    void (
                      'number' == typeof e._options.show &&
                      e.show(e._options.show)
                    ))
                  : ((e._firstrun = !0),
                    c.History &&
                    ...
                    /^[0-9]{1,4}$/.test(n) && c.History
                      ? e.show(n, d, !0)
                      : e._data[e._options.show] && e.show(e._options.show),
              ...
              a(b)
                ...
                .each(function (b, c) {
                  ...
                  var d = {},
                    ...
                    h = g.attr('href'),
                    i = g.attr('rel');
                  h && ('IMG' == c[0].nodeName || c.hasClass('video')) && B(h)
                    ? (d.video = h)
                    : h && c.hasClass('iframe')
                    ? (d.iframe = h)
                    : (d.image = d.big = h),
              ...
              h &&
                ...
                (c.thumb && c.image) ||
                  a.each(['thumb', 'image'], function (a, b) {
                    if ('image' == b && !e._options.videoPoster)
                      return void (c.image = d);
      ...
      destroy: function () {
        return (
          ...
          this.clearTimer(),
          K.removeFromArray(E, this),
          K.removeFromArray(D, this),
          c._waiters.length &&
      ...
      bindTooltip: function (a, b) {
        return (
          this._tooltip.bind.apply(this._tooltip, K.array(arguments)), this
        );
      },
      defineTooltip: function (a, b) {
        return (
          this._tooltip.define.apply(this._tooltip, K.array(arguments)), this
        );
      },
      refreshTooltip: function (a) {
        return (
          this._tooltip.show.apply(this._tooltip, K.array(arguments)), this
        );
      },
      openLightbox: function () {
        return (
          this._lightbox.show.apply(this._lightbox, K.array(arguments)), this
        );
      },
      closeLightbox: function () {
        return (
          this._lightbox.hide.apply(this._lightbox, K.array(arguments)), this
        );
      },
      ...
      addPan: function (b) {
        if (this._options.imageCrop !== !1) {
          ...
          return (
            ...
            this.addTimer('pan' + c._id, t, 50, !0),
            this
          );
        }
      },
      ...
      addElement: function (b) {
        var c = this._dom;
        return (
          a.each(K.array(arguments), function (a, b) {
      ...
      attachKeyboard: function (a) {
        return (
          this._keyboard.attach.apply(this._keyboard, K.array(arguments)), this
        );
      },
      detachKeyboard: function () {
        return (
          this._keyboard.detach.apply(this._keyboard, K.array(arguments)), this
        );
      },
      ...
      resize: function (b, c) {
        'function' == typeof b && ((c = b), (b = d)),
          (b = a.extend({ width: 0, height: 0 }, b));
        var e = this,
          f = this.$('container');
        return (
          ...
          (g._stageWidth = b || g.$('stage').width()),
            ...
            g._options.swipe
              ? (a.each(g._controls.slides, function (b, c) {
                  g._scaleImage(c),
                    a(c.container).css('left', g._stageWidth * b);
                }),
        ...
        if (this._options.preload) {
          ...
          try {
            for (b = this._options.preload; b > 0; b--)
              (a = new c.Picture()),
                (d = this.getData(e)),
                a.preload(this.isFullscreen() && d.big ? d.big : d.image),
                (e = this.getNext(e));
          } catch (a) {}
        }
      },
      show: function (d, e, f) {
        ...
        if (
          ...
          if (
            ((d = p.max(0, p.min(parseInt(d, 10), this.getDataLength() - 1))),
            (e = 'undefined' != typeof e ? !!e : d < this.getIndex()),
            (f = f || !1),
            !f && c.History)
          )
            return void c.History.set(d.toString());
          if (
            (this.finger &&
              d !== this._active &&
              ((this.finger.to = -(d * this.finger.width)),
              (this.finger.index = d)),
            (this._active = d),
            g)
          ) {
            ...
            this.trigger(a.extend(o, { type: c.LOADSTART })),
              j.$('container').removeClass('videoplay');
            var q = function () {
              (j._layers[d].innerHTML = j.getData().layer || ''),
                j.trigger(a.extend(o, { type: c.LOADFINISH })),
                j._playCheck();
            };
            j._preload(),
              b.setTimeout(function () {
                l.ready && a(l.image).attr('src') == k
                  ...
                  : (i.iframe && !i.image && (l.isIframe = !0),
                    l.load(k, function (b) {
                      (o.imageTarget = b.image),
                        j
                          ._scaleImage(b, q)
                          .trigger(a.extend(o, { type: c.IMAGE })),
                        q();
                    }));
              }, 100);
          } else
            h.push.call(this._queue, { index: d, rewind: e }),
      ...
      _show: function () {
        ...
        if (g) {
          ...
          e.$('container')
            .toggleClass('iframe', !!g.isIframe)
            .removeClass('videoplay');
          var o = (function (f, g, i, j, k) {
            return function () {
              var l;
              (M.active = !1),
                K.toggleQuality(g.image, e._options.imageQuality),
                    ...
                    .on('mouseup', function (g) {
                      if (!('number' == typeof g.which && g.which > 1)) {
                        if (f.iframe) {
                          ...
                          return (
                            a(h.container)
                              .css({ width: i, height: j, opacity: 0 })
                              .show()
                              .animate({ opacity: 1 }, 200),
                            void b.setTimeout(function () {
                              h.load(
                                f.iframe + (f.video ? '&autoplay=1' : ''),
                                { width: i, height: j },
                                function (a) {
                                  e.$('container').addClass('videoplay'),
                                    a.scale({
                                      width: e._stageWidth,
                                      height: e._stageHeight,
                                      iframelimit: f.video
                                        ? e._options.maxVideoSize
                                        : d,
                                    });
                                }
                              );
                        ...
                        return e._options.clicknext && !c.TOUCH
                          ? (e._options.pauseOnInteraction && e.pause(),
                            void e.next())
                          : f.link
                          ? void (e._options.popupLinks
                              ? (l = b.open(f.link, '_blank'))
                              : (b.location.href = f.link))
          ...
          this._options.carousel &&
            ...
            this._carousel.follow(f.index),
            e._preload(),
            K.show(k.container),
            (k.isIframe = g.iframe && !g.image),
            a(e._thumbnails[f.index].container)
              .addClass('active')
              .siblings('.active')
              .removeClass('active'),
            e.trigger({
            ...
            k.load(i, function (b) {
              ...
              e._scaleImage(b, {
                complete: function (b) {
                  'image' in j && K.toggleQuality(j.image, !1),
                    K.toggleQuality(b.image, !1),
                    e.removePan(),
                    e.setInfo(f.index),
                    ...
                    g.layer &&
                      ...
                      ((g.iframe && g.image) ||
                        ...
                        e._options.lightbox ||
                        e._options.clicknext) &&
                        h.css('cursor', 'pointer').off('mouseup').mouseup(n)),
                    g.video && g.image && L(b.container);
                  ...
                  if (
                    (a.each(
                      ...
                      function (a, b) {
                        if (b && e._options[a + 'Transition'] !== d)
                          return (i = e._options[a + 'Transition']), !1;
                      }
                    ),
                    i in M.effects == !1)
                  )
      ...
      getNext: function (a) {
        return (
          ...
          a === this.getDataLength() - 1 ? 0 : a + 1
        );
      },
      getPrev: function (a) {
        return (
          (a = 'number' == typeof a ? a : this.getIndex()),
          0 === a ? this.getDataLength() - 1 : a - 1
        );
      },
      next: function () {
      ...
      setCounter: function (a) {
        if (
          ('number' == typeof a
            ? a++
            : 'undefined' == typeof a && (a = this.getIndex() + 1),
    ...
    (c.addTheme = function (d) {
      d.name || c.raise('No theme name specified'),
        (!d.version || parseInt(10 * c.version) > parseInt(10 * d.version)) &&
          c.raise(
        ...
        'object' != typeof d.defaults
          ? (d.defaults = {})
          : (d.defaults = x(d.defaults));
      var e,
        f,
        g = !1;
      return (
        'string' == typeof d.css
          ? (a('link').each(function (a, b) {
              if (((e = new RegExp(d.css)), e.test(b.href)))
                return (g = !0), J(d), !1;
            }),
            g ||
              a(function () {
    ...
    (c.get = function (a) {
      return E[a]
        ...
        : 'number' != typeof a
        ? E
        : void c.raise('Gallery index ' + a + ' not found');
    }),
    ...
    (c.run = function (b, d) {
      return (
        a.isFunction(d) && (d = { extend: d }),
        a(b || '#galleria').galleria(d),
        c
      );
    }),
    ...
    (c.log = function () {
      ...
      if (!('console' in b && 'log' in b.console))
        return b.alert(c.join('<br>'));
      try {
    ...
    (c.Picture.prototype = {
      ...
      load: function (d, e, f) {
          ...
          return (
            ...
            a('#' + g).on(
              ...
              (function (c, d) {
                return function () {
                  b.setTimeout(function () {
                    a(c.image).css('visibility', 'visible'),
                      'function' == typeof d && d.call(c, c);
                  }, 10);
                };
              })(this, f)
            ),
        ...
        (this.image = new Image()),
          c.IE8 && a(this.image).css('filter', 'inherit'),
          c.IE ||
            c.CHROME ||
            c.SAFARI ||
                    ...
                    K.wait({
                      ...
                      error: function () {
                        j
                          ...
                          : (a(new Image()).on('load', o).attr('src', b.src),
                            (j = !0));
                      },
                      timeout: 100,
                    });
      ...
      scale: function (b) {
        ...
        return (
          K.wait({
            until: function () {
              return (
                (k = b.width || n.width() || K.parseValue(n.css('width'))),
                (l = b.height || n.height() || K.parseValue(n.css('height'))),
                k && l
              );
            },
            success: function () {
              ...
              b.max && (i = p.min(b.max, i)),
                ...
                a.each(['width', 'height'], function (b, c) {
                  a(e.image)[c](
                    (e[c] = e.image[c] = p.round(e.original[c] * i))
                  );
                }),
                a(e.container).width(k).height(l),
                b.canvas &&
                  G &&
                  ((G.elem.width = e.width),
                  (G.elem.height = e.height),
      ...
      var d =
          ...
          (c.HAS3D = (function () {
            var b,
              ...
              g = 0,
              h = 'transform';
            for (t().html.insertBefore(d, null); f[g]; g++)
              (c = f[g] ? f[g] + 'Transform' : h),
                void 0 !== d.style[c] &&
                  ((d.style[c] = 'translate3d(1px,1px,1px)'),
                  (b = a(d).css(
                    f[g] ? '-' + f[g].toLowerCase() + '-' + h : h
                  )));
            return (
              t().html.removeChild(d),
              ...
              (this.setX = function () {
                ...
                return d
                  ? void (a.MozTransform =
                      a.webkitTransform =
                      a.transform =
                        'translate3d(' + f.pos + 'px,0,0)')
                  : void (a.left = f.pos + 'px');
              }),
        ...
        (h.prototype = {
          ...
          setup: function () {
            (this.width = a(this.elem).width()),
              ...
              0 !== this.index &&
                ((this.index = p.max(0, p.min(this.index, this.length - 1))),
          ...
          ontouchstart: function (a) {
            ...
            (this.start = {
              ...
              (this.touching = !0),
              (this.deltaX = 0),
              f.on('touchmove', this.ontouchmove),
              f.on('touchend', this.ontouchend);
          },
          ontouchmove: function (a) {
            ...
            (b && b.length > 1) ||
              ...
              null === this.isScrolling &&
                (this.isScrolling = !!(
                  this.isScrolling ||
                  p.abs(this.deltaX) < p.abs(b[0].pageY - this.start.pageY)
                )),
              this.isScrolling ||
                (a.preventDefault(),
                (this.deltaX /=
                  ...
                  (this.index == this.length - 1 && this.deltaX < 0)
                    ? p.abs(this.deltaX) / this.width + 1.8
                    : 1),
          ...
          ontouchend: function (a) {
            ...
            var b =
                (+new Date() - this.start.time < 250 &&
                  p.abs(this.deltaX) > 40) ||
                p.abs(this.deltaX) > this.width / 2,
              c =
                (!this.index && this.deltaX > 0) ||
                (this.index == this.length - 1 && this.deltaX < 0);
            this.isScrolling ||
              this.show(
                this.index + (b && !c ? (this.deltaX < 0 ? 1 : -1) : 0)
              ),
              f.off('touchmove', this.ontouchmove),
              f.off('touchend', this.ontouchend);
          },
          show: function (a) {
            a != this.index
              ? this.config.onchange.call(this, a)
              : (this.to = -(a * this.width));
          },
          moveTo: function (a) {
            a != this.index &&
          ...
          loop: function () {
            ...
            if (
              (this.width &&
                a &&
                (b = p.max(0.5, p.min(1.5, p.abs(a / this.width)))),
              this.touching || p.abs(a) <= 1)
            )
              (this.pos = this.to),
                (a = 0),
                this.anim &&
              ...
              if (c > d || this.anim.destination != this.to)
    ...
    (a.fn.galleria = function (b) {
      ...
      return a(this).length
        ? this.each(function () {
            a.data(this, 'galleria') &&
              (a.data(this, 'galleria').destroy(), a(this).find('*').hide()),
              a.data(this, 'galleria', new c().init(this, b));
          })
        : (a(function () {
            a(d).length
              ? a(d).galleria(b)
